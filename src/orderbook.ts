...
function notifyUser(userAddress: string, message: any) {
...
async function createOrder(type: string, price: number, amount: number, userAddress: string, contractAddress: string) {
